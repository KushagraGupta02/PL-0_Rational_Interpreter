...
fun yyAction53 (strm, lastMatch : yymatch) = let
      val yytext = yymktext(strm)
      in
        yystrm := strm; (Tokens.RATIONAL ((yytext), !pos, !pos))
      end
...
fun yyQ26 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction51(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"A"
              then yyQ26(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
            else if inp < #"A"
              then if inp = #"0"
                  then yyQ26(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
                else if inp < #"0"
...
fun yyQ52 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction32(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"A"
              then yyQ26(strm', yyMATCH(strm, yyAction32, yyNO_MATCH))
            else if inp < #"A"
              then if inp = #"0"
                  then yyQ26(strm', yyMATCH(strm, yyAction32, yyNO_MATCH))
                else if inp < #"0"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction51(strm, yyNO_MATCH)
                      else yyQ26(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction51(strm, yyNO_MATCH)
                  else yyQ26(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
            else if inp = #"e"
...
fun yyQ66 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction35(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"A"
              then yyQ26(strm', yyMATCH(strm, yyAction35, yyNO_MATCH))
            else if inp < #"A"
              then if inp = #"0"
                  then yyQ26(strm', yyMATCH(strm, yyAction35, yyNO_MATCH))
                else if inp < #"0"
...
fun yyQ77 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction27(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"A"
              then yyQ26(strm', yyMATCH(strm, yyAction27, yyNO_MATCH))
            else if inp < #"A"
              then if inp = #"0"
                  then yyQ26(strm', yyMATCH(strm, yyAction27, yyNO_MATCH))
                else if inp < #"0"
       ...
       of NONE => yyAction51(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then yyQ93(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
            else if inp < #"e"
              then if inp <= #"`"
                  then yyAction51(strm, yyNO_MATCH)
                  else yyQ26(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
...
fun yyQ97 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction36(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"A"
              then yyQ26(strm', yyMATCH(strm, yyAction36, yyNO_MATCH))
            else if inp < #"A"
              then if inp = #"0"
                  then yyQ26(strm', yyMATCH(strm, yyAction36, yyNO_MATCH))
                else if inp < #"0"
       ...
       of NONE => yyAction51(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"a"
              ...
              then if inp = #"t"
                  then yyQ88(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
                  else yyQ26(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ26(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
              else yyAction51(strm, yyNO_MATCH)
       ...
       of NONE => yyAction51(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then yyQ101(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
            else if inp < #"o"
              then if inp <= #"`"
                  then yyAction51(strm, yyNO_MATCH)
                  else yyQ26(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
...
fun yyQ99 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction31(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"A"
              then yyQ26(strm', yyMATCH(strm, yyAction31, yyNO_MATCH))
            else if inp < #"A"
              then if inp = #"0"
                  then yyQ26(strm', yyMATCH(strm, yyAction31, yyNO_MATCH))
                else if inp < #"0"
...
fun yyQ113 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction34(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"A"
              then yyQ26(strm', yyMATCH(strm, yyAction34, yyNO_MATCH))
            else if inp < #"A"
              then if inp = #"0"
                  then yyQ26(strm', yyMATCH(strm, yyAction34, yyNO_MATCH))
                else if inp < #"0"
...
fun yyQ116 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction41(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"A"
              then yyQ26(strm', yyMATCH(strm, yyAction41, yyNO_MATCH))
            else if inp < #"A"
              then if inp = #"0"
                  then yyQ26(strm', yyMATCH(strm, yyAction41, yyNO_MATCH))
                else if inp < #"0"
       ...
       of NONE => yyAction51(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #"a"
                  then yyQ114(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
                  else yyAction51(strm, yyNO_MATCH)
            else if inp <= #"z"
              then yyQ26(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
              else yyAction51(strm, yyNO_MATCH)
...
fun yyQ25 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction46(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"="
              then yyQ123(strm', yyMATCH(strm, yyAction46, yyNO_MATCH))
...
fun yyQ23 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction49(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #">"
              then yyQ125(strm', yyMATCH(strm, yyAction49, yyNO_MATCH))
            else if inp < #">"
              then if inp = #"="
                  then yyQ124(strm', yyMATCH(strm, yyAction49, yyNO_MATCH))
       ...
       of NONE => yyAction52(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"/"
              ...
              then if inp = #"."
                  then yyQ43(strm', yyMATCH(strm, yyAction52, yyNO_MATCH))
...
fun yyQ12 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction7(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"*"
              then yyQ135(strm', yyMATCH(strm, yyAction7, yyNO_MATCH))
...
fun yyQ5 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction54(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #")"
              then yyQ6(strm', yyMATCH(strm, yyAction54, yyNO_MATCH))
...
in
  (case (!(yyss))
   of COMMENT => yyQ0(!(yystrm), yyNO_MATCH)
    | PL0_RATIONAL => yyQ1(!(yystrm), yyNO_MATCH)
